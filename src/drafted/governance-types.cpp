...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "ImpereumNetwork") type = ImpereumNetwork;
    if(strType == "ImpereumNetworkVariable") type = ImpereumNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == ImpereumNetwork) s = "ImpereumNetwork";
    if(type == ImpereumNetworkVariable) s = "ImpereumNetworkVariable";
