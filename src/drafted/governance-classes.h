 ...
 *
 *   // network
 *   CImpereumNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://www.impereum.io/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CImpereumNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CImpereumNetwork(UniValue objIn)
    {
...
// // can be under: ImpereumNetwork
// //   -- signature requirements : Key1(User)
// class CImpereumNetworkVariable : public CGovernanceObject
// {
// private:
